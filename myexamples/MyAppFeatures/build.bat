...
set __CANDLE_OPTS=%__CANDLE_OPTS% -ext WixBalExtension
...
set __CANDLE_OPTS=%__CANDLE_OPTS% "-dProductUpgradeInfo=%_PRODUCT_UPGRADE_INFO%"
...
set __LIGHT_COMMON_OPTS=%__LIGHT_COMMON_OPTS% -ext WixBalExtension -ext WixUIExtension
set __LIGHT_COMMON_OPTS=%__LIGHT_COMMON_OPTS% -b "pack=%_APP_DIR%" -b "rsrc=%_TARGET_DIR%\resources"
