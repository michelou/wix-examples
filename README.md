...
For instance our development environment looks as follows (*September 2022*) <sup id="anchor_05">[5](#footnote_05)</sup>:
...
Tool versions:
   ...
   magick 7.1.0-7, git 2.37.3.windows.1, diff 3.8
Tool paths:
...
<a href="https://git-scm.com/download/win">PortableGit-2.37.3-64-bit.7z.exe</a>        <i>( 44 MB)</i>
