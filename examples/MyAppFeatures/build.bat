...
@rem set __OPT_EXTENSIONS=-ext WixBalExtension -ext WiXUtilExtension
set __OPT_EXTENSIONS=-ext WixBalExtension
...
set __OPT_EXTENSIONS=-ext WixBalExtension -ext WixUIExtension
