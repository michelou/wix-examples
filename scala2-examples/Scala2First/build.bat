...
set __PACK_FILES=LICENSE NOTICE FSC_BAT FSC_SH REPL_BAT SCALA_BAT SCALA_SH SCALAC_BAT SCALAC_SH
...
set __REPLACE_PAIRS=-replace '\$PRODUCT_VERSION', '%_PRODUCT_VERSION%.0'
...
for %%i in (PRODUCT_CODE UPGRADE_CODE MAIN_EXECUTABLE PROGRAM_MENU_DIR APPLICATION_SHORTCUT %__PACK_FILES%) do (
