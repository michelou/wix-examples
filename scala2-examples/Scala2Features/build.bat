...
if not exist "%_LICENSE_FILE%" (
    ...
    @rem e.g. https://downloads.lightbend.com/scala/2.13.10/scala-docs-2.13.10.zip
...
set __N=0
for /f "delims=" %%f in ('dir /s /b "%_SOURCE_DIR%\*.wx?" "%_GEN_DIR%\Fragments*.wx?" 2^>NUL') do (
    set "__VAR_IN=$in!__N!"
